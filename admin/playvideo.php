                                        ...
                                        <div align='center' class="card-body table-border-style">
													<?php
														while ($row = $getSong->fetch(PDO::FETCH_ASSOC))
														{
															...
															echo "<div >";
															echo "<video src='".$location."' controls width='620px' height='680px' >";
															echo "</div>";
															echo "<br>";
															...
															<div class='likes-share-download d-flex align-items-center justify-content-between'>
															  ...
															  <a href='#'><i class='fa fa-download' aria-hidden='true'></i> Download ($downloads)</a>
															</div>";
