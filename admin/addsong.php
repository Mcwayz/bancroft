...
if(isset($_POST['submit']))
{
    ...
    if( in_array($audioFileType,$extensions_arr) ){
      ...
      // Check file size
        ...
        {
            echo"<script>alert('File too large, File Must Be Less Than 20MB!');</script>";
        }
        else
        {
            // Upload
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <div class="page-header-title">
                                                <h5 class="m-b-10">Add Audio Files</h5>
                                            </div>
                                            <ul class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                                <li class="breadcrumb-item"><a href="#">Media Uploads</a></li>
                                                <li class="breadcrumb-item"><a href="addsong.php">Audio File Uploads</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="mb-3 form-control" id='Artist_id' name='Artist_id' required>
                                                                ...
                                                                <?php while ($nam = $artist->fetch(PDO::FETCH_ASSOC)){     ?>
                                                                <option value="<?=$nam['artist_id'] ?>"><?=$nam['artist_name']?></option>
                                                                <?php }?>
                                                            </select>
                                                    ...
                                                    <div class="col-md-12">
                                                    <div class="form-group">
                                                           <label for="desc">Select Audio File</label>
